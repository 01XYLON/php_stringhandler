	 ...
	 <body>
		...
		<div class="wrapper">
			<form method="GET" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<fieldset>
				 <legend>Romy Spirlac GD1A</legend>
			...
			<hr>
				<ul>
					...
					<li class="showSpaces">String 1 getrimd trim():  <?php  echo trim ($input1, "gjfdk1"); ?> </li>
					<li class="showSpaces">String 2 getrimd trim():  <?php  echo trim ($input2, "bdf3f"); ?> </li>
